...
from pds_v3 import views, user_views, bootsnip_views, final_views, presenter_views, tmp_views, payment_views
...
urlpatterns = [
   ...
   #Home Page
    ...
    url(r'^user/presenter/$', user_views.presenter, name="presenter"),
    url(r'^user/presenter/$', user_views.presenter, name="presenter"),
